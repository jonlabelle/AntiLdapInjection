...
- **LdapForNet** Cross platform port of OpenLdap Client library and Windows LDAP to .NET Core \[ [NuGet](https://www.nuget.org/packages/LdapForNet) \] \[ [GitHub](https://github.com/flamencist/ldap4net) \]
- **Linq2Ldap** Wrapper around System.DirectoryServices using LINQ Expressions as LDAP filters \[ [NuGet](https://www.nuget.org/packages/Linq2Ldap) \] \[ [GitHub](https://github.com/cdibbs/linq2ldap) \]
